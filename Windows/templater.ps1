...
$usage = @'
    ...
    Options:
        ...
        '2021' '2020' 'CC 2019' 'CC 2018' 'CC 2017' 'CC 2015.3' 'CC 2015' 'CC 2014' 'CC' 'CS6' 'CS5.5' 'CS5'
...
if ($v -ne "2021" -and $v -ne "2020" -and $v -ne "CC 2019" -and $v -ne "CC 2018" -and $v -ne "CC 2017" -and $v -ne "CC 2015.3" -and $v -ne "CC 2015" -and $v -ne "CC 2014" -and $v -ne "CC" -and $v -ne "CS6" -and $v -ne "CS5.5" -and $v -ne "CS5") {
"
